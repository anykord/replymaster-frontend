    ...
    <>
      ...
      <section id="about">
        <div className="wrap">
          ...
          <div className="card">
            Replymaster — это универсальная платформа, которая автоматизирует работу с чатами, группами и личными сообщениями.
            Она помогает находить и прогревать клиентов прямо в их среде общения — в Telegram.
            Всё подключается и работает без сложной настройки — просто войди, выбери чат и начни действовать.
          </div>
        </div>
      </section>
      ...
      <section id="features">
        <div className="wrap">
          ...
          <div className="grid cols-3">
            <div className="card"><strong>1. Получать нативные лиды из открытых чатов</strong><p className="muted">Replymaster анализирует диалоги и подбирает людей, которые уже интересуются вашим продуктом.</p></div>
            <div className="card"><strong>2. Прогревать и продавать без давления</strong><p className="muted">Система помогает выстраивать естественные диалоги и сохраняет сценарии, которые работают лучше всего.</p></div>
            <div className="card"><strong>3. Вести собственные чаты и группы как администратор</strong><p className="muted">Автомодерация, приветствия, удаление спама и аналитика активности.</p></div>
            <div className="card"><strong>4. Старт «из коробки»</strong><p className="muted">Войдите, подключите чаты и начните использовать. Полная настройка занимает до 10 минут.</p></div>
            <div className="card"><strong>5. Автоматизация и аналитика</strong><p className="muted">Отслеживание активности, лидов и эффективности диалогов.</p></div>
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="wrap">
          © {new Date().getFullYear()} Replymaster · Все права защищены · <a href="#">Политика конфиденциальности</a>
        </div>
      </footer>
    </>
  );
